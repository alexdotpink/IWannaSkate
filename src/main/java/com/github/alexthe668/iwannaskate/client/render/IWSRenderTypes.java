...
public class IWSRenderTypes extends RenderType {
    ...
    public static final ResourceLocation SKATEBOARD_GLINT_TEXTURE = ResourceLocation.fromNamespaceAndPath(IWannaSkateMod.MODID, "textures/entity/skateboard/enchanted_glint.png");
